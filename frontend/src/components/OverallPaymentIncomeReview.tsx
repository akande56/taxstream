...
export function OverallPaymentIncomeReview() {
  const option = {
    tooltip: {
      trigger: "item",
    },
  ...
  return (
    <>
      <div className="chart__wrapper  flex items-center gap-4 p-4 justify-between space-y-8">
        <div className="left__x flex order-1 gap-6 ">
          <div className="lga__report bg-emerald-50 p-8 rounded w-fit">
            <table className="table-auto ">
              <thead>
                <tr>
                  <th className="pb-4">Text Area by LGA</th>
                  <th></th>
                </tr>
              </thead>
        ...
        <div className="chart__section  flex items-center flex-col ">
          <p className="text-2xl font-bold">Overall Payment Income Review</p>
          <ReactECharts
            option={option}
            style={{
              height: "440px",
