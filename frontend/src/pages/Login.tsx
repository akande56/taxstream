...
export function LoginPage() {
  ...
  const { login, loginError, loginInfo } = useAuth();
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="flex flex-col place-content-center m-0 p-8 bg-green-400">
      <div className="w-full h-screen bg-green-400 flex flex-col sm:flex-row p-4 gap-2 justify-around align-middle">
        <div className="flex items-center order-1 justify-center py-12">
          <div className="mx-auto grid w-[420px] gap-6 p-8 bg-white">
            <Form {...form}>
              <Toaster richColors position="top-right" />
        ...
        <div className="bg-green-400 flex place-content-center">
          <img
            src={logo}
            alt="Jigawa state mapImage"
            // width="1920"
